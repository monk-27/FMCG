...
// Only 4 pages exist — rest commented out
const footerLinks = {
  // products: {
  //   title: "Products",
  //   links: ["Home Care", "Personal Care", "Groceries", "Beverages", "All Products"],
  ...
  company: {
    title: "Company",
    links: ["About Us"], // Only this exists
  },
  support: {
    title: "Support",
    links: ["Contact Us"], // Only this exists
  },
  // legal: {
  //   title: "Legal",
  //   links: ["Privacy Policy", "Terms of Service", "Cookie Policy", "Disclaimer"],
    ...
    <footer className="bg-primary text-primary-foreground pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-primary-foreground/80 leading-relaxed max-w-md">
                Fast-growing FMCG export startup delivering India’s best essentials — globally, hassle-free.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-primary-foreground/80">
                  <Mail className="w-5 h-5 text-primary-foreground" />
                  <span>info@axisglobaltraders.com</span>
                </div>
                <div className="flex items-center gap-3 text-primary-foreground/80">
                  <Phone className="w-5 h-5 text-primary-foreground" />
                  <span>+91 98104 82171</span>
                </div>
                <div className="flex items-center gap-3 text-primary-foreground/80">
                  <MapPin className="w-5 h-5 text-primary-foreground" />
                  <span className="text-sm">
                    A-18, 2nd Floor, Jhilmil Industrial Area,<br />
                    GT Road, Shahdara, Delhi-110095
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          {/* Navigation Links (Only 2 active) */}
          {Object.entries(footerLinks).map(([key, section], index) => (
            <motion.div
              key={key}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <ul className="space-y-2">
                {section.links.map((link) => {
                  const href = link === "About Us" ? "/about" : "/contact"
                  return (
                    <li key={link}>
                      <Link
                        href={href}
          ...
          {/* Quick Links: Home & Products (Manual) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        >
          <p className="text-primary-foreground/60 text-sm mb-4 md:mb-0">
            © 2025 Axis Global Traders. All rights reserved.
          </p>
